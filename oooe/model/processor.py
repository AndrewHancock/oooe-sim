...
def get_processor() -> Processor:
    ...
    execution_units = [
        ExecutionUnit(op_times={'L.D' : 2}, reservation_stations=load_rs),
        ExecutionUnit(op_times={'SUB.D': 2}, reservation_stations=add_rs),
        ExecutionUnit(op_times={'MUL.D': 10, 'DIV.D': 40}, reservation_stations=mul_rs)
    ]

    return Processor(execution_units=execution_units)